...
def next_question():
    ...
    # Record the previous answer before selecting
    ...
    # Record the new question only after it
    # has been added to the active attempt.
    record_question_seen(
        user_id=user_id,
        question_id=
            next_question_id,
